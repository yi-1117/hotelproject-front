      ...
      <div class="content-wrapper">
          ...
          <div class="text-container">
              <div class="room-info" v-if="roomDetails">
                  ...
                  <button class="btn-reserve" @click="redirectToRoomSearch">立即訂房</button>
              </div>
          </div>
      </div>
  </div>
...
// 跳轉至空房查詢且下拉式選單選擇跳轉前的房型
const redirectToRoomSearch = () => {
  store.selectedRoomType = roomDetails.value.roomTypeName;
